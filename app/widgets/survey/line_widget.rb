...
#include Databasedotcom::Rails::Controller
	...
	has_widgets do
		...
		@line_items = session[:client].query( "select Id, Name, Answer_Sequence__c, Content_Description__c, Display_Format__c, Line__c, Line_Item_Type__c, Question_Description__c, Question_Type__c, Resource__c, Resource__r.Name, Resource_Name__c, Sort_Order__c, URL__c, Content_Type__c, Enable_Autocomplete__c, Help_Text__c, Calculation_Logic__c, Length__c, Max_Value__c, Min_Value__c, Required__c from Line_Item__c where Line__c = '#{@line.Id}' order by Sort_Order__c asc")
